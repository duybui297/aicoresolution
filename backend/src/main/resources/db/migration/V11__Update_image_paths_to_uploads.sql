-- V11__Update_image_paths_to_uploads.sql
-- Update image paths from /images/ to /uploads/images/ for the 5 seeded landing articles

-- 1. Update main posts table (thumbnails and content)
UPDATE posts 
SET 
    thumbnail_url = REPLACE(thumbnail_url, '/images/', '/uploads/'),
    content = REPLACE(content, '/images/', '/uploads/')
WHERE slug IN (
