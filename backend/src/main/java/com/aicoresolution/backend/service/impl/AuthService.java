...
public class AuthService implements IAuthService, CommandLineRunner {
    ...
    public UserResponse register(RegisterRequest request) {
        ...
        logger.info("Registering user: {} - RequestID: {}", request.getUsername(), requestId);
    ...
    public LoginResponse refresh(String refreshToken) {
        ...
        logger.info("Refreshing token - TraceID: {}", traceId);
    ...
    public ApiResponse logout(String refreshToken) {
        String traceId = HeaderUtils.getTraceId();
        logger.info("User logout - TraceID: {}", traceId);
